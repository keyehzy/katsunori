PROGRAM ZIGZAGHAND
  USE OGPF
  USE INTERFACE
  USE MY_LIB, ONLY: TRISECT, FTRANS_MARTINS, ENERGY_MARTINS, WRITE_VECTOR, WRITE_VECTOR_MATRIX
  ...
  DO I2 = -NGRIDX,NGRIDX
     ...
     DO I1 = -NGRIDP, NGRIDP
        IF(SIGNAL .AND. FKNP(I2,I1).LT.T1) THEN
           CALL TRISECT(FTRANS_MARTINS, AKX(I2), NRIB, M, AKP(I1-1), AKP(I1),R)
           ROOTS(I2,T2) = R
           T2 = T2+1
  ...
  CALL WRITE_VECTOR_MATRIX(2, AKX, ENERGY1(:,1:6))
  CALL WRITE_VECTOR_MATRIX(3, AKX, ENERGY2(:,1:6))
